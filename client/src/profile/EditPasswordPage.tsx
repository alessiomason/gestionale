        ...
        <>
                ...
                <Col md={8} className="glossy-background">
                    ...
                    <InputGroup className="padded-form-input">
                        ...
                        <FloatingLabel controlId="floatingInput" label="Conferma nuova password">
                            <Form.Control type='password' placeholder="Conferma nuova password" isInvalid={invalidPassword}
            ...
            <Row className="d-flex justify-content-center mt-4">
                <Col md={4} className="d-flex justify-content-center">
                    <Button className="glossy-button" onClick={handleSubmit}>Cambia password</Button>
                </Col>
            </Row>
        </>
    );
